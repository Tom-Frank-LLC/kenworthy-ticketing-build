...
**104 briefs** — 91 shipped, 8 built, 5 open, 0 needs triage, 0 closed.
...
- `P1` **Deleting a price tier and saving never duplicates tiers again, and the duplicates already in production are repaired**<br>`data` — [brief](briefs/BRIEF-duplicate-tiers-fix.md) · [notes](briefs/../FINDINGS-duplicate-price-tiers.md)
