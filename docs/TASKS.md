...
**63 briefs** — 58 shipped, 2 built, 3 open, 0 needs triage, 0 closed.
...
- **Listings show the other showtimes inline and play trailers in a lightbox**<br>`ux` — [brief](briefs/BRIEF-listings-showtimes-trailer.md)
