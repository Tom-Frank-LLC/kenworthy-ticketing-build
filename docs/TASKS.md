...
**84 briefs** — 73 shipped, 6 built, 5 open, 0 needs triage, 0 closed.
...
- `P2` **Month calendar opens with the current week as the top row**<br>`ux` — [brief](briefs/BRIEF-calendar-current-week-top.md)
