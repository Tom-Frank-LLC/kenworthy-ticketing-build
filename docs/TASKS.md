...
**108 briefs** — 95 shipped, 8 built, 5 open, 0 needs triage, 0 closed.
...
- `P3` **The home page's curator's-pick band wears the marquee-lights header, and the pick titles drop to h3 beneath it**<br>`ux` — [brief](briefs/BRIEF-curator-marquee-header.md)
