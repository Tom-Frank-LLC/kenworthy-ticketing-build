...
- `P2` **A film can be ticketed through an outside site, the way an event can, and nothing sells against it here**<br>`feature` — [brief](briefs/BRIEF-movie-external-ticketing.md)
