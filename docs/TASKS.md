...
- `P1` **Links to past showings land on a real page instead of a 404 or a silent bounce**<br>`bug` — [brief](briefs/BRIEF-past-event-graceful.md) · [notes](briefs/FINDINGS-past-event-visibility.md)
