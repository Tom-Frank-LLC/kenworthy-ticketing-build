...
**110 briefs** — 97 shipped, 8 built, 5 open, 0 needs triage, 0 closed.
...
- `P3` **The marquee ring's side columns sit directly under the top and bottom runs' corner bulbs, at every weight**<br>`ux` — [brief](briefs/BRIEF-marquee-corner-alignment.md)
