...
**69 briefs** — 62 shipped, 4 built, 3 open, 0 needs triage, 0 closed.
...
- `P2` **An admin adds a whole run of showtimes in one pass, and is told exactly which ones landed**<br>`feature` — [brief](briefs/BRIEF-batch-showtimes.md)
