...
**105 briefs** — 92 shipped, 8 built, 5 open, 0 needs triage, 0 closed.
...
- `P2` **A film can be ticketed through an outside site, the way an event can, and nothing sells against it here**<br>`feature` — `#329` — [brief](briefs/BRIEF-movie-external-ticketing.md)
