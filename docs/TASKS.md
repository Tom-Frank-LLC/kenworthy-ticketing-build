...
**100 briefs** — 88 shipped, 7 built, 5 open, 0 needs triage, 0 closed.
...
- `P1` **Staff are emailed about every marquee and rental request, and admins choose who**<br>`feature` — [brief](briefs/BRIEF-staff-notifications.md)
