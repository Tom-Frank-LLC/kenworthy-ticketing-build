...
**77 briefs** — 69 shipped, 5 built, 3 open, 0 needs triage, 0 closed.
...
- `P2` **A page with nothing to sell can be a curator's pick**<br>`feature` — `#218`, `#220`, `#222` — [brief](briefs/BRIEF-manual-curator-slide.md)
