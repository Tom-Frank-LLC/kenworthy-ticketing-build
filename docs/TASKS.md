...
**102 briefs** — 90 shipped, 7 built, 5 open, 0 needs triage, 0 closed.
...
- **Staff can add ticket discounts (percent, $ per ticket, $ per order) that reconcile with Square to the cent**<br>`feature` — `#311`, `#312` — [brief](briefs/BRIEF-ticket-discounts.md) · [notes](briefs/FINDINGS-square-order-arithmetic.md)
