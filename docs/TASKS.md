...
**90 briefs** — 79 shipped, 7 built, 4 open, 0 needs triage, 0 closed.
...
- `P2` **A calendar day draws every showing on it, and the week row grows to suit**<br>`ux` — [brief](briefs/BRIEF-calendar-cells-fit-all-showings.md)
...
- `P2` **On a phone, list titles get a second line and the curator's band stops padding itself out**<br>`ux` — [brief](briefs/BRIEF-mobile-list-titles-curator-space.md)
...
- **Shorter hero, larger site-wide type, and a preview pane that clears the nav**<br>`ux` — `#228`, `#195` — [brief](briefs/BRIEF-ui-polish-hero-fonts-sticky.md)
...
- **An admin can mark a showing sold out by hand, which closes online sales without hiding the showing**<br>`feature` — `#213` — [brief](briefs/BRIEF-manual-sold-out.md)
...
- **The rentals availability table pushes /rentals sideways on a phone**<br>`bug` — `#216` — [brief](briefs/BRIEF-rentals-mobile-table-overflow.md)
- **A formatted description reads formatted in the listing previews, not just on the ticket page**<br>`bug` — `#212` — [brief](briefs/BRIEF-richtext-preview-surfaces.md) · [notes](briefs/FINDINGS-richtext-description-surface.md)
