...
**78 briefs** — 71 shipped, 4 built, 3 open, 0 needs triage, 0 closed.
...
- **Live Events manages its own showings, and one door replaces two create buttons**<br>`ux` — [brief](briefs/BRIEF-live-events-section-ux.md)
