...
Deno.serve(async (req: Request) => {
  ...
  // free ($0) showing has no card step at all, so this is validated after
  // pricing rather than here — see the post-pricing guard below.
  ...
  // is why free tickets have to skip Square entirely, below.)
