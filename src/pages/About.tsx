...
// Copy ported from kenworthy.org/about — mission, goals and board roster. The
// history timeline lives on /history; this page used to preview its first three
// entries and no longer does.
const GOALS = [
...
// Ordered by office, then by member — so a title change moves the row.
const BOARD: Array<{ name: string; title: string }> = [
  { name: 'Stevie Steely-Johnson', title: 'President' },
  { name: 'Eric Billings', title: 'Vice President' },
  { name: 'Kyle Howerton', title: 'Secretary' },
  { name: "Mike O'Brien", title: 'Treasurer' },
